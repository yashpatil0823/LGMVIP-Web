    ...
    return(
        <form className="enrollForm">
            ...
            <label>Skills : 
                ...
                <input type="checkbox" name="skills" onChange={handleSkills} value="JavaScript" className="skills"/><label>JavaScript</label>
                <input type="checkbox" name="skills" onChange={handleSkills} value="ReactJs" className="skills"/><label>ReactJs</label>
            </label><br/>
